function ph = tau_CV_plot(g0s,gbars,channels,fig_title,variation,varname)
...
for i = 1:1
  variation_cv = (std(variation(i,:))./mean(variation(i,:)));
  ...
  if ~exist('variation','var')
    ...
    label = strcat('tau_',varname,model.subscript(channels{i}));
